...
{ 
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE);//使能CAN1时钟	
	...
	CAN_FilterInitStructure.CAN_FilterIdHigh=0x000<<5 ;//16							//0x02
	CAN_FilterInitStructure.CAN_FilterIdLow=0x201<<5;										//0x00
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh=0x000<<5;//16					//0x03
	CAN_FilterInitStructure.CAN_FilterMaskIdLow=0x000<<5;								//0x01
...
void USB_LP_CAN1_RX0_IRQHandler(void)
{
	...
	for(i=0;i<8;i++)
	{
		CANReceiveBuffer[RxMessage.FMI][i]=RxMessage.Data[i];
	}
}
